...
class AgentOrchestrator:
    ...
    def process_query(self, query: str, context: RequestContext, max_steps: int = 5):
        ...
        history_list = conversations_repository.get_messages_by_conversation_id(context.conversation_id,
                                                                                context.session_id)
        ...
        for step in range(max_steps):
            ...
            if action.lower().startswith("call:"):
                ...
                conversations_repository.add_message(context.conversation_id, context.session_id, 'assistant',
                                                     final_response)
